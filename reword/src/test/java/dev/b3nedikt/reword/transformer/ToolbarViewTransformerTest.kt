...
class ToolbarViewTransformerTest {
    ...
    private val context: Context
        get() {
            val context = com.nhaarman.mockitokotlin2.spy(ApplicationProvider.getApplicationContext() as Context)
            val resources = com.nhaarman.mockitokotlin2.spy<Resources>(context.resources)
